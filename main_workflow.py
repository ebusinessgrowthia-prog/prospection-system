...
from email_validator import EmailValidator  # ✅ Ajouté
...
class ProspectionOrchestrator:
    def __init__(self):
        ...
        self.validator = EmailValidator(  # ✅ Utilisation correcte
    ...
    def process_webhook(self, webhook_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        dorks = self.gemini.generate_dorks(organized_data['agence_info'])
    ...
    def _run_prospection_campaign(self, agence_data: Dict[str, Any], dorks: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            personalized_emails = self._create_personalized_emails(validated_prospects, agence_data['agence_info'])
    ...
    def _create_personalized_emails(self, prospects: List[Dict[str, Any]], agence_info: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        for prospect in prospects:
            ...
            email_content = self.gemini.generate_personalized_email(analysis, agence_info, prospect)
    ...
    def _send_emails(self, personalized_emails: List[Dict[str, Any]], agence_info: Dict[str, Any]) -> int:
        ...
        for email_data in emails_to_send:
            ...
            if result['success']:
                ...
                self.sheets.update_prospect_status(prospect['email'], 'CONTACTED', f"Email envoyé le {datetime.now().isoformat()}")
    ...
    def run_daily_optimization(self):
        ...
        if stats:
            ...
            self.sheets.update_performance_metrics({'optimisation': optimization})
